...
function BStyleFlagSCRIPTS() {
	let rplyArr = ['\
加油嗎？該說什麼才好……唔！抱歉、不知道該說什麼，但無論什麼難關我都會陪你一起努力的！讓我們一起加油吧！測試更改', '\
真的好累、快要不行了，但想到有你一起加油就能夠再堅持一下了！你也不要輕易就放棄！', '\
就算你沒有說「幫我加油」，我也會應援你的！看到你這麼努力的樣子我覺得相當感動。', '\
你一定可以的！就算不是長男也有很多能夠辦到的事，毅力！毅力！', '\
加油嗎？當然沒問題！我會一直幫你加油的！所以再努力一下下好不好？我會陪著你的！', '\
物語開始時13歳→修行後（鬼殺隊入隊時）15歳', '\
物語開始時156cm→修行後（鬼殺隊入隊時）165cm', '\
物語開始時53kg→修行後（鬼殺隊入隊時）61kg', '\
東京府 奥多摩郡 雲取山（現:西多摩郡 雲取山）', '\
「我只是希望你永遠不要忘記我。」', '\
「我只是希望能永遠和你在一起。」', '\
...
function randomReply() {
	let rplyArr = ['\
哇、很有精神的樣子，今天也讓我們一起努力吧！啊、抱歉，忘了說最重要的事——早安！', '\
早安，吃早餐了嗎？如果不好好吃早餐的話會沒有精神呢……這樣我會擔心的。', '\
早安、很有精神呢，一大早就能遇見你我覺得很開心哦！', '\
早安！今天天氣很好呢！, '\
嘎嘎嘎。', '\
wwwwwwwwwwwwwwwww', '\
